...
* 1. stolpec: Drzava, imenska spremenljivka
* 2. stolpec: ISO koda
...
Tretjo fazo projekta sem začel z hitro analizo, da bi dobil boljši pregled nad zbranimi podatki. Najprej sem si pogledal povprečni delež socialno ogroženih pred in po transferjih, tekom let za celotno evropo. Pri tem sem si pomagal s številom prebivalcev držav, da sem dobil tehtano povprečje za celotno Evropo. Ugotovil sem, da se delež tekom let ni kaj prida spremenil. Tako je bilo  povprečje socialno ogroženih v Evropi pred socialnimi transferji skozi leta 25,9%, po le-teh pa 16,7%. 
...
kable(head(starost_zdruzeni), caption = "Starostna struktura socialno ogorženih v Evropi")
...
```{r zemljevid, echo=FALSE, message=FALSE, fig.align='center'}
print(zem_e) 
...
Za konec, pa si v spodnjem grafu poglejmo še, kako se pri zmanjševanju socialne ogroženosti svojih prebivalcev odrežejo druge države :
...
Sedaj ko sem orisal situacijo socialne ogrozenosti v Evropi glede na kategorije spola in starosti po različnih državahV, pa bom v naslednji fazi napredne analize podatkov, poizkušal odkriti kakšne so, če obstajajo, korelacije med revščino in kategorijami, kot so BDP, ginijev koeficient itd. 
